...
$selqry="select * from tbl_booking b inner join tbl_test t on t.test_id=b.test_id inner join tbl_user u on u.user_id=b.user_id where b.booking_id='".$_GET["id"]."'";
    ...
    <section class="main-pd-wrapper" style="width: 1000px; margin: auto" id="content">
        ...
        <table style="width: 100%; table-layout: fixed">
          <tr>
            ...
            >
              ...
              >
              	<span
                style="color:#F93;font-size:56px">Health Lab</span>
      ...
      >
        <thead style="display: table-header-group">
          ...
          >
            <td colspan="3">
              <p>Booking Date:- <?php echo $data["booked_datetime"] ?></p>
              <p style="margin: 5px 0">Invoice Generated:- <?php echo date("Y-m-d"); ?></p>
            </td>
           <!-- <td colspan="3" style="width: 300px">
              <h4 style="margin: 0">Tested By:</h4>
              <p>
