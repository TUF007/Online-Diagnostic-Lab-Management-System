            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse justify-content-end" id="navbar-wd">
                    <ul class="navbar-nav">
                        ...
                        <li><a class="nav-link" href="viewassign.php">Assignment</a></li>
                        <li><a class="nav-link" href="complaint.php">Complaints</a></li>
                        <li><a class="nav-link" href="Logout.php">Logout</a></li>
                        <li>
                        <a class="nav-link" href="#">Welcome      <?php echo $_SESSION["sname"]?></a></li>
                    </ul>
                </div>
            </div>
        </nav>
