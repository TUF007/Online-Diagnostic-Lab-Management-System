...
if(isset($_POST["submit"]))
{
 ...
 if($hid=="")
 {
 $ins="insert into tbl_complaint(complaint_title,complaint_content,complaint_date,staff_id)
	values('".$title."','".$content."',curdate(),'".$_SESSION["sid"]."')";
 mysql_query($ins);
...
<table width="420" height="211" border="1">
  <tr>
    ...
    <td>
      ...
      <input required type="text" name="title" id="title" value="<?php echo $title ?>"  />
...
<table width="515" height="97" border="1">
  <tr style="background-color: #00cb86;
   ...
   <?php
  		$i=0;
  		$selQry="select * from tbl_complaint where staff_id='".$_SESSION["sid"]."'";
