	...
	if(isset($_POST["btn_update"]))
{
	...
	if($db_password==$current_password)
	{
		...
		{
		  $upQry = "update tbl_staff set staff_password='$new_password' where staff_id='".$_SESSION["sid"]."'";
...
<table width="379" height="165" border="1">
  ...
  <tr>
    <td colspan="2" align="center"><input type="submit" name="btn_update" id="btn_update" value="Update" />      <input type="reset" name="cancel" id="cancel" value="Cancel" /></td>
